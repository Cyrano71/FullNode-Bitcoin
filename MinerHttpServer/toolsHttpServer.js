...
const {processMyBlock} = require("../MinerBlock/BlockTools");
const {printBlockChain} = require("../MinerBlockChain/printBlockChain");
const {gatherMoneyInBlockChain} = require("../MinerTxns/checkTxns");
