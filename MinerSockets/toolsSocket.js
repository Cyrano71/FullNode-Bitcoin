...
const {processBlockFromOtherNode} = require("../MinerBlock/BlockTools");

const {OneChainIsmoreLonger} = require("../MinerBlockChain/ForkChainTools");

const {replaceChain} = require("../MinerBlockChain/CheckValidChainReceive");
const {isValidChain} = require("../MinerBlockChain/CheckValidChainReceive");

const {initConnection} = require("../MinerSockets/SocketInit");
const {connectToPeers} = require("../MinerSockets/SocketInit");

/*
//const {checkIntegrityOfBlockChain} = require("../MinerBlockChain/BlockChainTools");
